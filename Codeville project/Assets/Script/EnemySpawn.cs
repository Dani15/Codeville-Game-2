...
public class EnemySpawn : MonoBehaviour
{
    ...
    public float spawnOffset = 10f; //How far off-screen to the right enemies spawn
    public float moveSpeed = 5f; // Speed at whcih enemies move left
    ...
    void SpawnEnemy()
    {
        ...
        float spawnX = Camera.main.transform.position.x + spawnOffset;
